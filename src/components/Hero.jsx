    ...
    <section className="relative min-h-[calc(100vh-120px)] flex items-center overflow-hidden bg-trisGray-light py-16" id="home">
      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
        <div className="max-w-2xl animate-fade-in-up">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold uppercase tracking-tighter mb-4">
          ...
          <p className="text-lg md:text-xl font-semibold text-gray-900 mb-2 font-heading tracking-wide uppercase">
            INTRODUCING ALL-INCLUSIVE
          </p>
          <p className="text-lg md:text-xl font-semibold text-gray-900 mb-8 font-heading tracking-wide uppercase">
            eBike SUBSCRIPTIONS
          </p>

          <p className="text-base text-trisGray-text mb-8">
        ...
        <div className="relative rounded-2xl isolate ">
          <div className="relative w-full group ">
            ...
            <div className="w-full relative flex  items-center justify-center group/video">
              ...
              {/* Logo Watermark */}
              <div className="absolute bottom-6 right-6 md:bottom-4 md:right-3 bg-white px-4 py-2 rounded-xl shadow-[0_10px_20px_rgba(0,0,0,0.1)] hover:scale-105 transition-all duration-300">
